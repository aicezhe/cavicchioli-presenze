...
/**
 * Emblema della Scuola Secondaria "Giacomo Cavicchioli":
 * scudo bordeaux con bordo dorato, libro aperto, iniziali GC,
 * stella in alto e nastro con l'anno di fondazione MDCCCLXXXII.
 */
export default function Crest({ size = 96, variant = 'full', className }: CrestProps) {
  ...
  return (
    <svg
      ...
      role="img"
      aria-label='Emblema della Scuola Secondaria "Giacomo Cavicchioli"'
      className={className}
    >
      {isFull && (
      ...
      {/* Scudo: campo bordeaux con doppio bordo dorato */}
      <path
      ...
      <g>
        ...
        />
        {/* Dorso */}
        <line x1="70" y1="63" x2="70" y2="85" stroke={GOLD} strokeWidth="1.6" />
        {/* Righe di testo */}
        <g stroke={CRIMSON} strokeWidth="1.1" opacity="0.55">
      ...
      {isFull && (
        <g>
          {/* Nastro con l'anno di fondazione */}
          <path
            d="M18 148 L34 141 L34 159 L18 152 Z"
            fill={CRIMSON}
            stroke={GOLD}
            strokeWidth="1.5"
          />
          <path
            d="M122 148 L106 141 L106 159 L122 152 Z"
            fill={CRIMSON}
            stroke={GOLD}
            strokeWidth="1.5"
          />
          <rect x="30" y="140" width="80" height="20" rx="2" fill={CRIMSON} stroke={GOLD} strokeWidth="1.5" />
          <text
            x="70"
            y="154"
            textAnchor="middle"
